function [ CMat ] = calculateSparseCoefficients( Xp,lambda)
%CALCULATESPARSECOEFFICIENTS Summary of this function goes here
...
% add kernel as a parameter of the funciton handle being passed in
