...
addpath /host/Users/ibogun2010/Dropbox/Code/Libraries/TFOCS   % add TFOCS to your path, so change this to suit your computer
...
% writerObj = VideoWriter('backgroundSubtracktion.avi');
% open(writerObj);
