function [forwardTracks, trackMask] = createBackwardTracks(flow, detectionFilename,withConstraints )
%CREATEBACKWARDTRACKS This function will create tracks from detections and optical
%flow
%   
%
%   Input:
...
for j=n:-1:1
    ...
    for d=1:length(detectionFrom)
        ...
        for k=(j-1):-1:1
            ...
            % get the flow
            backward=flow.forward(k).flow;
            forward=flow.backward(k).flow;
